...
var customizeWikiEditor = function () {
	...
	// We add a simple override for WikiEditor-Tables to surpress the table-caption
    $("#wikieditor-toolbar-dialog-wrapper").on(
    ...
    function () {
      ...
      var rowsVal = $("#wikieditor-toolbar-table-dimensions-rows").val(),
        ...
        header = $("#wikieditor-toolbar-table-dimensions-header").prop(
          "checked"
        )
          ? 1
          : 0;
      ...
      if (rows * cols > 1000) {
        ...
        alert(
          mw.msg(
            ...
            mw.language.convertNumber(1000)
          )
        );
        return;
      }
