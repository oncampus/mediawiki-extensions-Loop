...
<xsl:stylesheet version="1.0"
	...
	<xsl:include href="pdf/toc.xsl"></xsl:include>
	<!-- ende -->
	...
	<!-- LOOP_OBJECTS -->
	<xsl:include href="pdf/loop_object.xsl"></xsl:include>
	<!-- /LOOP_OBJECTS -->

	<!-- here was some more toc -->
...
<xsl:template name="font_icon">
 ...
 -->		</fo:basic-link>
	...
	<!-- table start -->
	<xsl:include href="pdf/table.xsl"/>
	<!-- table end -->
