		...
		<xsl:variable name="looparea_type">
			<xsl:choose>
				<xsl:when test="@type='task'">
					<xsl:value-of select="$word_looparea_task"></xsl:value-of>
				</xsl:when>
				<xsl:when test="@type='timerequirement'">
					<xsl:value-of select="$word_looparea_timerequirement"></xsl:value-of>
				</xsl:when>
				<xsl:when test="@type='learningobjectives'">
					<xsl:value-of select="$word_looparea_learningobjectives"></xsl:value-of>
				</xsl:when>
				<xsl:when test="@type='arrangement'">
					<xsl:value-of select="$word_looparea_arrangement"></xsl:value-of>
				</xsl:when>
				<xsl:when test="@type='example'">
					<xsl:value-of select="$word_looparea_example"></xsl:value-of>
				</xsl:when>
				<xsl:when test="@type='reflection'">
					<xsl:value-of select="$word_looparea_reflection"></xsl:value-of>
				</xsl:when>
				<xsl:when test="@type='notice'">
					<xsl:value-of select="$word_looparea_notice"></xsl:value-of>
				</xsl:when>
				<xsl:when test="@type='important'">
					<xsl:value-of select="$word_looparea_important"></xsl:value-of>
				</xsl:when>
				<xsl:when test="@type='annotation'">
					<xsl:value-of select="$word_looparea_annotation"></xsl:value-of>
				</xsl:when>
				<xsl:when test="@type='definition'">
					<xsl:value-of select="$word_looparea_definition"></xsl:value-of>
				</xsl:when>
				<xsl:when test="@type='formula'">
					<xsl:value-of select="$word_looparea_formula"></xsl:value-of>
				</xsl:when>
				<xsl:when test="@type='markedsentence'">
					<xsl:value-of select="$word_looparea_markedsentence"></xsl:value-of>
				</xsl:when>
				<xsl:when test="@type='sourcecode'">
					<xsl:value-of select="$word_looparea_sourcecode"></xsl:value-of>
				</xsl:when>
				<xsl:when test="@type='summary'">
					<xsl:value-of select="$word_looparea_summary"></xsl:value-of>
				</xsl:when>
				<xsl:when test="@type='indentation'">
					<xsl:value-of select="$word_looparea_indentation"></xsl:value-of>
				</xsl:when>
				<xsl:when test="@type='norm'">
					<xsl:value-of select="$word_looparea_norm"></xsl:value-of>
				</xsl:when>
				<xsl:when test="@type='law'">
					<xsl:value-of select="$word_looparea_law"></xsl:value-of>
				</xsl:when>
				<xsl:when test="@type='question'">
					<xsl:value-of select="$word_looparea_question"></xsl:value-of>
				</xsl:when>
				<xsl:when test="@type='practice'">
					<xsl:value-of select="$word_looparea_practice"></xsl:value-of>
				</xsl:when>
				<xsl:when test="@type='exercise'">
					<xsl:value-of select="$word_looparea_exercise"></xsl:value-of>
				</xsl:when>
				<xsl:when test="@type='websource'">
					<xsl:value-of select="$word_looparea_websource"></xsl:value-of>
				</xsl:when>
				<xsl:when test="@type='experiment'">
					<xsl:value-of select="$word_looparea_experiment"></xsl:value-of>
				</xsl:when>
				<xsl:when test="@type='citation'">
					<xsl:value-of select="$word_looparea_citation"></xsl:value-of>
				</xsl:when>
				<xsl:when test="@type='citation'">
					<xsl:value-of select="$word_looparea_citation"></xsl:value-of>
				</xsl:when>
				<xsl:otherwise>
					<xsl:if test="@icontext">
						<xsl:value-of select="@icontext"></xsl:value-of>
					</xsl:if>
	...
	<xsl:template name="loop_spoiler">
		...
		<xsl:choose>
			<xsl:when test="./descendant::extension[@extension_name='loop_spoiler_text']">
				<xsl:apply-templates select="./descendant::extension[@extension_name='loop_spoiler_text']"
									 mode="loop_object"></xsl:apply-templates>
			</xsl:when>
			<xsl:when test="@text">
	...
	<xsl:template name="loop_object">
		...
		<xsl:choose>
			<xsl:when test="$object/descendant::extension[@extension_name='loop_title']">
				<xsl:apply-templates select="$object/descendant::extension[@extension_name='loop_title']"
									 mode="loop_object"></xsl:apply-templates>
			</xsl:when>
			<xsl:otherwise>
		...
		<xsl:if test="($object/@description) or ($object/descendant::extension[@extension_name='loop_description'])">
			...
			<xsl:choose>
				<xsl:when test="$object/descendant::extension[@extension_name='loop_description']">
					<xsl:apply-templates select="$object/descendant::extension[@extension_name='loop_description']"
										 mode="loop_object"></xsl:apply-templates>
				</xsl:when>
				<xsl:otherwise>
		...
		<xsl:choose>
			<xsl:when test="$object/descendant::extension[@extension_name='loop_copyright']">
				...
				<xsl:apply-templates select="$object/descendant::extension[@extension_name='loop_copyright']"
									 mode="loop_object"></xsl:apply-templates>
			</xsl:when>
			<xsl:otherwise>
				<xsl:element name="break">
