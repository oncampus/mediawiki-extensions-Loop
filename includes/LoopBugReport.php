...
class SpecialLoopBugReport extends SpecialPage
{
	...
	public function makeForm($request, $page, $url, $captcha, $error = false)
	{
		...
		$html .= '<form method="POST" class="mw-editform mt-3 mb-3 ml-2 mr-2" id="bugreport-form" enctype="multipart/form-data">';
		...
		$html .= '<input type="submit" class="mw-htmlform-submit mw-ui-button mw-ui-primary mw-ui-progressive mt-2 d-block"' .
			'id="bugreport-submit" value="' .
			$this->msg('loopbugreport-send') .
			'"></input>';
